  ...
  return (
    <section className="bg-brand-canvas px-5 py-20 lg:relative lg:h-[1223px] lg:p-0" aria-labelledby="about-team-heading">
      <div className="mx-auto grid max-w-content gap-12 lg:block">
        <img alt="Rok Šped tim u kancelariji" className="h-auto w-full rounded-card-lg object-cover lg:absolute lg:left-[72px] lg:top-[55px] lg:h-[435px] lg:w-[645px]" decoding="async" height="860" loading="lazy" src="/assets/about/team-intro.jpg" width="1290" />
        ...
        <div className="mt-16 overflow-hidden lg:absolute lg:left-0 lg:top-[672px] lg:mt-0 lg:h-[513px] lg:w-full">
          <img alt="" aria-hidden="true" className="h-auto w-full lg:h-[513px] lg:object-cover" decoding="async" height="513" loading="lazy" src="/assets/about/team-strip.png" width="1437" />
