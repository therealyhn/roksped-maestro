...
function HomeLocationsSection({section}) {
  return (
    <section aria-labelledby="home-locations-heading" className="mx-auto min-h-[100svh] w-full max-w-canvas bg-brand-canvas py-20 lg:min-h-[1049px] lg:pb-0 lg:pt-[150px]" id="lokacije">
      <div className="px-gutter-fluid">
        <div className="mx-auto max-w-[526px] text-center">
          <h2 className="text-[clamp(2.5rem,7.16vw,3.4375rem)] font-medium leading-none tracking-[-0.05em] lg:whitespace-nowrap" id="home-locations-heading">{section.heading}</h2>
