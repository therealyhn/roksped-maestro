...
function MissionMediaGrid({mission}) {
  return <div className="mt-10 grid gap-4 lg:relative lg:h-[698px] lg:block">
    <div className="overflow-hidden rounded-input lg:absolute lg:left-0 lg:top-0 lg:h-[580px] lg:w-[458px]"><img alt="Narandžasti transportni kontejneri" className="h-full w-full object-cover" decoding="async" height="1159" loading="lazy" src={missionImage} width="869" /></div>
    <div className="flex min-h-[102px] items-center gap-[21px] rounded-input bg-white px-[22px] py-[13px] lg:absolute lg:left-0 lg:top-[596px] lg:h-[102px] lg:w-[458px]"><div className="h-[72px] w-[72px] shrink-0 overflow-hidden"><img alt="" aria-hidden="true" className="h-[72px] w-[180px] max-w-none object-contain object-left" decoding="async" height="383" loading="lazy" src={certificateImage} width="960" /></div><div><p className="text-[24px] font-semibold leading-[1.3] tracking-[-0.01em]">Excellent</p><p className="text-[20px] leading-[1.3] tracking-[-0.01em]">Privredna komora Srbije</p></div></div>
